  ...
  return (
    ...
    className="w-full px-6 flex justify-between items-center max-lg:flex-col" id="home">
      <div className="flex flex-col mt-20 max-w-full mx-auto">
        ...
        <p className="font-poppins textcolor2 dark:text-slate-100">Software Developer | SEO Specialist | AI Automation Specialist</p>
        <br/>
        <p className="font-poppins textcolor2 text-justify max-xs:text-[14px] dark:text-slate-100">
            I'm a dedicated professional with a passion for creating impactful solutions. I thrive in collaborative environments and excel at problem-solving. Seeking opportunities to learn, grow, and contribute to real-world projects. Let's connect and build innovative software together.
        </p>
        <div>
      ...
      <div className="max-w-full w-auto max-ss:hidden">
        <img src={profile1} alt="Emmanuel Pascua Profile" className="max-w-lg py-10 px-10 home-img" />
      </div>
    </motion.section>
  )
}
