  ...
  return (
    <section className="w-full px-6 flex flex-col justify-between items-center " id="about">
      ...
      className="flex flex-row justify-center items-center max-w-full m-auto pt-5 max-lg:flex-col">
        ...
        <img src={profile2} alt="Emmanuel Pascua About Image" className="max-w-lg mx-auto my-10 flex justify-center items-center rounded-[2rem] " />
        </div>
        ...
        className="flex flex-col justify-center items-center mt-10 max-w-full mx-auto">
          ...
          Highly motivated professional based in the Philippines. Exploring the field drives me to constantly seek new opportunities to grow and maximize my skills. I am particularly interested in building solutions and automation for businesses and entities and am committed to delivering high-quality solutions and experience to my clients.
          </p>

          <ul className="list-none flex flex-row justify-center items-center gap-5 mt-10 text-center">
            {aboutMe.map(( about ) => (
              <li key={about.title} className={`font-poppins font-semiboldflex flex-col justify-center items-center text=[18px] textcolor1`} >
